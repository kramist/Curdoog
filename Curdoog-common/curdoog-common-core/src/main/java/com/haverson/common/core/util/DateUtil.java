...
public class DateUtil {
    ...
    public static final String PATTERN_AAb = "yyyyMMdd HH:mm:ss";
    ...
    public static final String PATTERN_AAc = "yyyy年MM月dd日";
    ...
    public static long getIntervalDays(Date date1, Date date2) {
        ...
        Date mydate = null;
        try {
            date = formatDateOfDate(date1, pattern);
            mydate = formatDateOfDate(date2, pattern);
        } catch (Exception e) {
        }
    ...
    /**
     * 将Date类型的日期格式化，返回Date类型
     *
     * @param date
     * @return
     */
    public static Date formatDateOfDate(Date date, String pattern) {
        try {
    ...
    /**
    *@Description: 传入时间与当前时间间隔-分钟
    * @param date
    *@author: zj
    *@createTime: 2020/11/6
    */
    public static Long getIntervalMinute(Date date) {
    ...
    public static Date getDateFrontOrAfterDay(Date date, int day) {
