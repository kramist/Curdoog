...
import com.haverson.common.core.constant.StringPool;
import com.haverson.common.core.enums.RandomType;
...
public class StringUtil extends org.springframework.util.StringUtils {
    ...
    private static Pattern comelPattern = Pattern.compile("[A-Z]");
    public final static String APPEND_STR_0 = "0";
    ...
    public static List<String> split(CharSequence str, char separator, int limit, boolean isTrim, boolean ignoreEmpty) {
        ...
        return StrSpliteUtil.split(str.toString(), separator, limit, isTrim, ignoreEmpty);
    }
    ...
    public static List<String> split(CharSequence str, CharSequence separator, int limit, boolean isTrim, boolean ignoreEmpty) {
        ...
        return StrSpliteUtil.split(str.toString(), separatorStr, limit, isTrim, ignoreEmpty);
    }
    ...
    public static String[] split(CharSequence str, CharSequence separator) {
        ...
        final String separatorStr = (null == separator) ? null : separator.toString();
        return StrSpliteUtil.splitToArray(str.toString(), separatorStr, 0, false, false);
    }
     ...
     * @param len 每一个小节的长度
     * @return 截取后的字符串数组
     * @see StrSpliteUtil#splitByLength(String, int)
     */
    public static String[] split(CharSequence str, int len) {
        if (null == str) {
            return new String[]{};
        }
        return StrSpliteUtil.splitByLength(str.toString(), len);
    }
    ...
    /**
     * 获取一个字符串在另一个字符串里出现的次数
     * @param str 原始字符串
     * @param key  key字符串
     * @return
     */
    public static int get(String str, String key) {
        if(ObjectUtil.isEmpty(str) || ObjectUtil.isEmpty(key)){
            return 0 ;
        }
        int count = 0;
        int index;//定义一个位置
    ...
    public static String getNoneNull(String str) {
        return isEmpty(str) ? "": str;
    }

    public static String fillZero(Integer id, Integer size) {
        return String.format("%" + size.toString() + "d", id).replace(" ", "0");
    }
