...
public class DateTimeUtil {
    ...
    /**
     * 转换timeMillis到yyyy-MM-dd HH:mm:ss格式
     * @return
     */
    public static String millis2DateTimeStr(Long timeMillis){
        SimpleDateFormat dateformat = new SimpleDateFormat( DateUtil.PATTERN_DATETIME);
